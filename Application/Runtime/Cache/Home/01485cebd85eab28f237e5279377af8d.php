	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div>
				当前筛选条件：
				<!--品牌-->
				<?php $brand = I('get.brand_id');?>
				<?php if($brand):?>
					<span>
						品牌：<?php echo explode('-',$brand)[1];?>
						<a href="<?php echo filterUrl('brand_id');?>">X</a>
					</span>
				<?php endif;?>
				<!--价格-->
				<?php $price = I('get.price');?>
				<?php if($price):?>
					<span>
						品牌：<?php echo $price;?>
				...
				<?php endif;?>
				<?php
 foreach($_GET as $k => $v): if(strpos($k,'attr_') === 0): $urlAttrName = strrchr($v,'-'); ?>
				
				<span>
					<?php echo ltrim($urlAttrName, '-');?>:
					<?php echo str_replace($urlAttrName,'',$v) ?>
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/key_search/key/%E5%90%8E%E8%A1%97%E7%94%B7%E5%AD%A9/brand_id/<?php echo $v['brand_id'];?>-<?php echo $v['brand_name'];?>"><?php echo $v['brand_name']?></a></dd>
						<?php endforeach;?>
					</dl>
					<?php endif;?>
					<?php if(!I('get.price')): ?>
					<dl>
						...
						<dd><a href="/index.php/Home/Search/key_search/key/%E5%90%8E%E8%A1%97%E7%94%B7%E5%AD%A9/price/<?php echo $v;?>"><?php echo $v?></a></dd>
						<?php endforeach;?>
					</dl>
					<?php endif;?>
					<!--属性-->
					<?php foreach($searchData['attr'] as $k=>$v): $attrName = 'attr_'.$v[0]['attr_id']; if(isset($_GET[$attrName])) continue; ?>
					<dl>
						<dt><?php echo $k;?>:</dt>
						<?php foreach($v as $k1=> $v1):?>
						<dd ><a href="/index.php/Home/Search/key_search/key/%E5%90%8E%E8%A1%97%E7%94%B7%E5%AD%A9/<?php echo $attrName;?>/<?php echo $v1['attr_value'];?>-<?php echo $k;?>"><?php echo $v1['attr_value'];?></a> </dd>
						<?php endforeach;?>
					</dl>
					<?php endforeach;?>
				</div>
			...
			<div class="sort mt10">
				<dl>
					...
					<dd <?php if(strpos($odby,'price_')=== 0) echo 'class="cur"';?>><a  href="<?php echo filterUrl('odby');?>/odby/<?php echo $odby=='price_desc'?'price_asc':'price_desc' ;?>">
						价格
						<?php if(strpos($odby, 'price_') === 0): ?>
						<?php echo $odby == 'price_desc' ? '↓' : '↑'; ?>
						<?php endif; ?>
					</a></dd>
					<!--<dd><a href="<?php echo filterUrl('odby');?>/odby/xl">评论数</a></dd>-->
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a target="_blank" href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php showImage($v['mid_logo']);?></a></dt>
							<dd><a target="_blank" href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php echo $v['goods_name'];?></a></dt>
							<dd><strong><?php echo $v['shop_price'];?></strong></dt>
							<dd><a href=""><em>已有10人评价</em></a>
								<a href=""><em>销量 <?php echo (int)$v['xl'];?></em></a>
							</dt>
						</dl>
					</li>
					<?php endforeach;?>
