      ...
      <div class="floor_left fl">
           ...
           <div class="goodslist fl">
                <h2>
                     ...
                     <span <?php if($k==0) echo 'class="on"';?>><?php echo $v1['cat_name'];?></span>
                     <?php endforeach;?>
                </h2>
                
                <div class="goodslist_wrap">
                     <?php foreach($v['recSubCat'] as $k1 => $v1):?>
                     <div <?php if($k1>0) echo 'class="none"';?>><!--第二个div默认隐藏-->
                          <ul>
                               <?php foreach($v1['goods'] as $k2=>$v2):?>
                               <li>
                                    <dl>
                                         <dt><a target="_blank" href="<?php echo U('goods?id='.$v2['id']);?>"><?php showImage($v2['mid_logo']);?></a></dt>
                                         <dd><a target="_blank" href="<?php echo U('goods?id='.$v2['id']);?>"><?php echo $v2['goods_name'];?></a></dd>
