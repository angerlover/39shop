...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Admin/edit/id/3/p/1.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                ...
                <td>
                    ...
                    <input <?php echo $check;?> type="checkbox" value="<?php echo $v['id'];?>" name="role_id[]">
