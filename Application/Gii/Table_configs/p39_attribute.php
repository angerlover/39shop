...
return array(
	...
	'validate' => "
		...
		array('attr_name', '1,300', '属性名称的值最长不能超过 300 个字符！', 1, 'length', 3),
		...
		array('type_id', 'require', '类别id不能为空！', 1, 'regex', 3),
		array('type_id', '1,300', '类别id的值最长不能超过 300 个字符！', 1, 'length', 3),
	",
	/********************** 表中每个字段信息的配置 ****************************/
	'fields' => array(
		'attr_name' => array(
	...
	'search' => array(
		...
		array('type_id', 'normal', '', 'like', '类别id'),
	),
);